...
import { Descriptions, Select, Space, Table, Tag, Button, Popconfirm } from 'antd'
...
const ItemDetailContainer = () => {
  ...
  const {setCartQty, setCart, cart_qty} = useContext(CartContext)
  let buying_data = []
