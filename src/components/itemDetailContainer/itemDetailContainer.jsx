...

      {
        ...
        render: (_, record) => (
          <Space size={55}>
            ...
            <Popconfirm title="Confirmar compra" description="¿Confirma la compra del juego?" onConfirm={() => buy_confirm(record)} okText="Confirmo" cancelText="Cancelar" icon={<ShoppingCartOutlined style={{color: 'blue',}}/>}> 
